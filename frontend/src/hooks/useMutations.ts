...
import { assetsApi, cargoApi, cargoBaysApi, cargoCategoriesApi, cargoPlacementsApi, contactsApi, crewApi, eventsApi, holomapApi, scenariosApi, sensorContactsApi, shipsApi, systemStatesApi, tasksApi } from '../services/api';
